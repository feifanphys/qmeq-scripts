...
hsingle =  {(0,0): Eq1+mu1.subs([(vL, vbiasL),(vR, vbiasR),(vGU, vgateup),(vGD, vgatedown)]),
            (1,1): Eq2+mu2.subs([(vL, vbiasL),(vR, vbiasR),(vGU, vgateup),(vGD, vgatedown)]),
            (2,2): Eq3+mu3.subs([(vL, vbiasL),(vR, vbiasR),(vGU, vgateup),(vGD, vgatedown)]),
            (0,1): -omegapres,
            (0,2): -omegapres,
            (1,2): -omegapres
}
...
def stab_calc(system, bfield, vlst, vglst, dV=0.0001):
    ...
    for j1 in range(vgpnt):
        ...
        for j2 in range(vpnt):
            ...
            system.change(hsingle={(0,0): Eq1+mu1.subs([(vL, vbiasL),(vR, vbiasR),(vGU, vgateup),(vGD, vgatedown)]),
                                  (1,1): Eq2+mu2.subs([(vL, vbiasL),(vR, vbiasR),(vGU, vgateup),(vGD, vgatedown)]),
                                  (2,2): Eq3+mu3.subs([(vL, vbiasL),(vR, vbiasR),(vGU, vgateup),(vGD, vgatedown)]),
                                  (0,1): -omegapres,
                                  (0,2): -omegapres,
            ...
            stab[j1, j2] = abs(np.trace(product))
            #stab[j1, j2] = system.current[0] + system.current[2] + system.current[4]
...
vpnt, vgpnt = 101, 101
vlst = np.linspace(-200, 400, vpnt)
vglst = np.linspace(-200, 400, vgpnt)
