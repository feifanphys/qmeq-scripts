    ...
    for j1 in range(vgpnt):
        ...
        for j2 in range(vpnt):
            system.change(hsingle={(0,0):E_0 + Cs/Csigma * vlst[j2]/2 - Cd/Csigma * vlst[j2]/2 - Cg/Csigma * vglst[j1],
                          (1,1):E_1 + Cs/Csigma * vlst[j2]/2 - Cd/Csigma * vlst[j2]/2 - Cg/Csigma * vglst[j1],
                          (2,2):E_2 + Cs/Csigma * vlst[j2]/2 - Cd/Csigma * vlst[j2]/2 - Cg/Csigma * vglst[j1],
                          (3,3):E_3 + Cs/Csigma * vlst[j2]/2 - Cd/Csigma * vlst[j2]/2 - Cg/Csigma * vglst[j1]})
