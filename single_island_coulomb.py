...
def stab_calc(system, bfield, vlst, vglst, dV=0.0001):
    ...
    for j1 in range(vgpnt):
        ...
        for j2 in range(vpnt):
            system.change(hsingle={(0,0):-2.5*E_c + Cs/Csigma * vlst[j2]/2 - Cd/Csigma * vlst[j2]/2 - Cg/Csigma * vglst[j1],
                          (1,1):-2.5*E_c + Cs/Csigma * vlst[j2]/2 - Cd/Csigma * vlst[j2]/2 - Cg/Csigma * vglst[j1],
                          (2,2):-2.5*E_c + Cs/Csigma * vlst[j2]/2 - Cd/Csigma * vlst[j2]/2 - Cg/Csigma * vglst[j1],
                          (3,3):-2.5*E_c + Cs/Csigma * vlst[j2]/2 - Cd/Csigma * vlst[j2]/2 - Cg/Csigma * vglst[j1],
                          (4, 4): -2.5*E_c + Cs/Csigma * vlst[j2]/2 - Cd/Csigma * vlst[j2]/2 - Cg/Csigma * vglst[j1],
                          (5, 5): -2.5*E_c + Cs/Csigma * vlst[j2]/2 - Cd/Csigma * vlst[j2]/2 - Cg/Csigma * vglst[j1]})
