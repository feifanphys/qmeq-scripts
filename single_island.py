...
def stab_calc(system, bfield, vlst, vglst, dV=0.0001):
    ...
    for j1 in range(vgpnt):
        ...
        for j2 in range(vpnt):
            system.change(hsingle={(0,0):0.5*E_c - 3 * E_c + Cs/Csigma * vlst[j2]/2 - Cd/Csigma * vlst[j2]/2 - Cg/Csigma * vglst[j1],
                          (1,1):0.5*E_c - 2 * E_c + Cs/Csigma * vlst[j2]/2 - Cd/Csigma * vlst[j2]/2 - Cg/Csigma * vglst[j1],
                          (2,2):0.5*E_c - 1 * E_c + Cs/Csigma * vlst[j2]/2 - Cd/Csigma * vlst[j2]/2 - Cg/Csigma * vglst[j1],
                          (3,3):0.5*E_c + 0 * E_c + Cs/Csigma * vlst[j2]/2 - Cd/Csigma * vlst[j2]/2 - Cg/Csigma * vglst[j1],
                          (4, 4): 0.5*E_c + 1 * E_c + Cs/Csigma * vlst[j2]/2 - Cd/Csigma * vlst[j2]/2 - Cg/Csigma * vglst[j1],
                          (5, 5): 0.5*E_c + 2 * E_c + Cs/Csigma * vlst[j2]/2 - Cd/Csigma * vlst[j2]/2 - Cg/Csigma * vglst[j1],
                          (6, 6): 0.5*E_c + 3 * E_c + Cs/Csigma * vlst[j2]/2 - Cd/Csigma * vlst[j2]/2 - Cg/Csigma * vglst[j1],
                          (7, 7): 0.5*E_c + 4 * E_c + Cs/Csigma * vlst[j2]/2 - Cd/Csigma * vlst[j2]/2 - Cg/Csigma * vglst[j1]})
...
def stab_plot(stab, stab_cond, vlst, vglst, gam):
    ...
    tt = " levels = " + str(nsingle) + " Single island"
