...
vgateup, vgatedown, vbiasL, vbiasR = 0.0, 0.0, 4.0, -4.0
...
mulst = {0: -vbiasL, 1: -vbiasR, 2: -vbiasL, 3: -vbiasR,  4: -vbiasL, 5: -vbiasR,
        6: -vbiasL, 7: -vbiasR, 8: -vbiasL, 9: -vbiasR,  10: -vbiasL, 11: -vbiasR}
tlst =  {0: temp,    1: temp,     2: temp,    3: temp,  4: temp, 5: temp,
        6: temp,    7: temp,     8: temp,    9: temp,  10: temp, 11: temp}
...
def stab_plot(stab, stab_cond, vlst, vglst, gam):
    ...
    p1_im = plt.imshow(stab.T, extent=[xmin, xmax, ymin, ymax], aspect='auto', origin='lower', cmap = plt.get_cmap('Spectral'), vmin=0.000, vmax = 0.010)
